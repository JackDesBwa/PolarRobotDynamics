...
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][3] for i in range(kmax)))
if simu_config.plot_otherspeed:
	plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][4] for i in range(kmax)))
...
plt.subplot(423)
plt.title('XY (mm)')
plt.plot(tuple(plots[i][1] * 1000 for i in range(kmax)), tuple(plots[i][2] * 1000 for i in range(kmax)))
plt.axis('equal')
plt.subplot(424, sharex=axes_t_tics)
plt.title('Commands (%)')
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][5] * 100 for i in range(kmax)))
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][6] * 100 for i in range(kmax)))
plt.subplot(425, sharex=axes_t_tics)
plt.title('Angle (deg)')
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][7] * 180 / pi for i in range(kmax)))
plt.subplot(426, sharex=axes_t_tics)
plt.title('Curviligne distance (mm)')
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][8] * 1000 for i in range(kmax)))
plt.subplot(427, sharex=axes_t_tics)
plt.title('X (mm)')
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][1] * 1000 for i in range(kmax)))
plt.subplot(428, sharex=axes_t_tics)
plt.title('Y (mm)')
plt.plot(tuple(plots[i][0] for i in range(kmax)), tuple(plots[i][2] * 1000 for i in range(kmax)))
...
if simu_config.plot_states:
	...
	plt.plot(tuple(plots[i][8] for i in range(kmax)), tuple(plots[i][10] for i in range(kmax)))
	plt.subplot(322)
	plt.title('theta / dtheta')
	plt.plot(tuple(plots[i][7] * 180 / pi for i in range(kmax)), tuple(plots[i][9] * 180 / pi for i in range(kmax)))
	plt.subplot(323)
	plt.title('curv / theta')
	plt.plot(tuple(plots[i][8] for i in range(kmax)), tuple(plots[i][7] * 180 / pi for i in range(kmax)))
	plt.subplot(324)
	plt.title('dcurv / dtheta')
	plt.plot(tuple(plots[i][10] for i in range(kmax)), tuple(plots[i][9] * 180 / pi for i in range(kmax)))
	plt.subplot(325)
	plt.title('theta / dcurv')
	plt.plot(tuple(plots[i][7] * 180 / pi for i in range(kmax)), tuple(plots[i][10] for i in range(kmax)))
	plt.subplot(326)
	plt.title('curv / dtheta')
	plt.plot(tuple(plots[i][8] for i in range(kmax)), tuple(plots[i][9] * 180 / pi for i in range(kmax)))
